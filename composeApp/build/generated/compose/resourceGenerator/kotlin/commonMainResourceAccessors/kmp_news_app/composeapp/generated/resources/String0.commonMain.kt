...
private object CommonMainString0 {
  ...
  public val apply_btn: StringResource by 
      lazy { init_apply_btn() }

  public val article_detail: StringResource by 
      lazy { init_article_detail() }
  ...
  public val choose_a_theme: StringResource by 
      lazy { init_choose_a_theme() }
  ...
  public val delete_bookmark: StringResource by 
      lazy { init_delete_bookmark() }

  public val delete_bookmark_description: StringResource by 
      lazy { init_delete_bookmark_description() }
...
internal fun _collectCommonMainString0Resources(map: MutableMap<String, StringResource>) {
  ...
  map.put("apply_btn", CommonMainString0.apply_btn)
  map.put("article_detail", CommonMainString0.article_detail)
  map.put("bookmark", CommonMainString0.bookmark)
  map.put("cancel", CommonMainString0.cancel)
  map.put("choose_a_theme", CommonMainString0.choose_a_theme)
  map.put("dark_mode", CommonMainString0.dark_mode)
  map.put("delete", CommonMainString0.delete)
  map.put("delete_bookmark", CommonMainString0.delete_bookmark)
...
internal val Res.string.apply_btn: StringResource
  get() = CommonMainString0.apply_btn

private fun init_apply_btn(): StringResource = org.jetbrains.compose.resources.StringResource(
  "string:apply_btn", "apply_btn",
    setOf(
      org.jetbrains.compose.resources.ResourceItem(setOf(),
    "composeResources/kmp_news_app.composeapp.generated.resources/values/strings.commonMain.cvr",
    43, 25),
...
internal val Res.string.article_detail: StringResource
  get() = CommonMainString0.article_detail

private fun init_article_detail(): StringResource = org.jetbrains.compose.resources.StringResource(
...
internal val Res.string.choose_a_theme: StringResource
  get() = CommonMainString0.choose_a_theme

private fun init_choose_a_theme(): StringResource = org.jetbrains.compose.resources.StringResource(
  "string:choose_a_theme", "choose_a_theme",
    setOf(
      org.jetbrains.compose.resources.ResourceItem(setOf(),
    "composeResources/kmp_news_app.composeapp.generated.resources/values/strings.commonMain.cvr",
    164, 42),
...
internal val Res.string.delete_bookmark: StringResource
  get() = CommonMainString0.delete_bookmark

private fun init_delete_bookmark(): StringResource = org.jetbrains.compose.resources.StringResource(
  "string:delete_bookmark", "delete_bookmark",
    setOf(
      org.jetbrains.compose.resources.ResourceItem(setOf(),
    "composeResources/kmp_news_app.composeapp.generated.resources/values/strings.commonMain.cvr",
    329, 43),
...
internal val Res.string.delete_bookmark_description: StringResource
  get() = CommonMainString0.delete_bookmark_description

private fun init_delete_bookmark_description(): StringResource =
    org.jetbrains.compose.resources.StringResource(
  "string:delete_bookmark_description", "delete_bookmark_description",
    setOf(
      org.jetbrains.compose.resources.ResourceItem(setOf(),
    "composeResources/kmp_news_app.composeapp.generated.resources/values/strings.commonMain.cvr",
    237, 91),
